...
/*-----------------------------------------------------------------------------------*/
 	...
 	var options = [ {selector: '#numbers-mobile-list1', offset: 0, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list2', offset: 0, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list3', offset: 0, callback: function(el) { Materialize.showStaggeredList($(el)); } }];
