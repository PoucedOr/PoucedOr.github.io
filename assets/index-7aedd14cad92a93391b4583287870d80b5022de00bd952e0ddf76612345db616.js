...
/*-----------------------------------------------------------------------------------*/
 	...
 	var options = [ {selector: '#numbers-mobile-list1', offset: 100, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list2', offset: 100, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list3', offset: 100, callback: function(el) { Materialize.showStaggeredList($(el)); } }];
