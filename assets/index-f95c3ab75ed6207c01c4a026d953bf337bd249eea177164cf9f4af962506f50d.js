...
/*-----------------------------------------------------------------------------------*/
 	...
 	var options = [ {selector: '#numbers-mobile-list1', offset: 150, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list2', offset: 150, callback: function(el) { Materialize.showStaggeredList($(el)); } },
									{selector: '#numbers-mobile-list3', offset: 150, callback: function(el) { Materialize.showStaggeredList($(el)); } }];
